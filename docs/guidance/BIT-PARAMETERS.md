...
`BOX_NO_LID_B`, `BOX_WALL_THICKNESS`, `CHAMFER_N`, `DEBUG_B`, `FTR_CUTOUT_BOTTOM_PCT`, `FTR_CUTOUT_DEPTH_MAX`, `LBL_DEPTH`, `LBL_SPACING`, `LBL_IMAGE`, `LBL_AUTO_SCALE_FACTOR`, `LID_CUTOUT_SIDES_4B`, `LID_TABS_4B`, `LID_STRIPE_WIDTH`, `LID_STRIPE_SPACE`, `LID_SOLID_LABELS_DEPTH`, `DIV_THICKNESS`, `DIV_TAB_RADIUS`, `DIV_TAB_TEXT_FONT`, `DIV_TAB_TEXT_SPACING`, `DIV_TAB_TEXT_CHAR_THRESHOLD`, `DIV_TAB_TEXT_EMBOSSED_B`, `DIV_FRAME_TOP`, `DIV_FRAME_BOTTOM`, `DIV_FRAME_RADIUS`, `G_PRINT_LID_B`, `G_PRINT_BOX_B`, `G_ISOLATED_PRINT_BOX`, `G_VISUALIZATION_B`, `G_VALIDATE_KEYS_B`, `G_WALL_THICKNESS`, `G_TOLERANCE_DETENT_POS`, `G_PRINT_MMU_LAYER`, `G_FIT_TEST_B`, `G_DETENT_THICKNESS`, `G_DETENT_SPACING`, `G_DETENT_DIST_FROM_CORNER`, `G_DETENT_MIN_SPACING`, `G_LID_THICKNESS`, `G_COLORIZE_B`, `G_PREVIEW_NO_LABELS_B`
